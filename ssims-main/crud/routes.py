...
@application.route("/add_a_student", methods=["POST", "GET"])
def add_a_student():
    connection = my_sql.connect()
    cursor = connection.cursor()
    ...
    return render_template("add_a_student.html", title="Add a Student", 
...
def update(id_number):
    ...
    return render_template("add_a_student.html", title="Update Student Records", 
...
@application.route("/add_a_course", methods=["POST", "GET"])
def add_a_course():
    connection = my_sql.connect()
    cursor = connection.cursor()
    ...
    return render_template("add_a_course.html", title="Add a Course", 
...
def update_a_course(course_code):
    ...
    return render_template("add_a_course.html", title="Update Course Records", 
...
@application.route("/add_a_college", methods=["POST", "GET"])
def add_a_college():
    connection = my_sql.connect()
    cursor = connection.cursor()
    ...
    return render_template("add_a_college.html", title="Add a College", 
...
def update_a_college(college_code):
    ...
    return render_template("add_a_college.html", title="Update College Records", 
